...
int FlatBuffers::serialize(const Response& msg) {
    ...
    auto a = builder.CreateString(msg.fields.empty() ? "" : *msg.fields.at("field1"));
    auto b = builder.CreateString(msg.fields.empty() ? "" : *msg.fields.at("field2"));
    auto c = builder.CreateString(msg.fields.empty() ? "" : *msg.fields.at("field3"));
    auto d = builder.CreateString(msg.fields.empty() ? "" : *msg.fields.at("field4"));
    auto e = builder.CreateString(msg.fields.empty() ? "" : *msg.fields.at("field5"));
    auto f = builder.CreateString(msg.fields.empty() ? "" : *msg.fields.at("field6"));
    auto g = builder.CreateString(msg.fields.empty() ? "" : *msg.fields.at("field7"));
