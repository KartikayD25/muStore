...
int MuSer::serialize(const Response &msg) {
  ...
  if (msg.fields.empty()) {
    ...
    p.set_field1(*msg.fields.at("field1"));
    p.set_field2(*msg.fields.at("field2"));
    p.set_field3(*msg.fields.at("field3"));
    p.set_field4(*msg.fields.at("field4"));
    p.set_field5(*msg.fields.at("field5"));
    p.set_field6(*msg.fields.at("field6"));
    p.set_field7(*msg.fields.at("field7"));
    p.set_field8(*msg.fields.at("field8"));
    p.set_field9(*msg.fields.at("field9"));
    p.set_field10(*msg.fields.at("field0"));
    p.set_field11(msg.key + '\n');
  }
#ifdef MU_SER_TC
