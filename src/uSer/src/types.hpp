...
//     return "message";
//   }
//   std::cerr << LINE_LOCATION << "type string not found. type: " <<
//   ((int)type)
//             << std::endl;
//   exit(1);
// }
...
//     break;
//   };
//   std::cerr << LINE_LOCATION << "Size not defined for type. " <<
//   typeToStr(type)
//             << std::endl;
//   exit(1);
// }
...
//                 << "Type conversion not implemented. to: " << type <<
//                 std::endl;
//       exit(1);
//     }
//     return nullptr;
...
template <typename T> struct GetUserType {
...
template <typename T> constexpr bool isSameType(UserTypes type) {
